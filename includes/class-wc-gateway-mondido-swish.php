...
class WC_Gateway_Mondido_Swish extends WC_Gateway_Mondido_HW {
	/**
	 * Init
	 */
	public function __construct() {
		...
		$this->icon     = apply_filters( 'woocommerce_mondido_swish_icon', plugins_url( '/assets/images/swish.png', dirname( __FILE__ ) ) );
		$this->supports = array(
			'products',
			'refunds',
		);
		...
		$this->title       = isset( $this->settings['title'] ) ? $this->settings['title'] : __( 'Swish', 'woocommerce-gateway-mondido' );
		...
		$this->order_button_text = isset( $this->settings['order_button_text'] ) ? $this->settings['order_button_text'] : __( 'Pay with Swish', 'woocommerce-gateway-mondido' );
	...
	public function init_form_fields() {
		$this->form_fields = array(
			'enabled'           => array(
				...
				'type'    => 'checkbox',
				'label'   => __( 'Enable Mondido Swish', 'woocommerce-gateway-mondido' ),
				'default' => 'no'
			),
			'title'             => array(
				...
				'default'     => __( 'Swish', 'woocommerce-gateway-mondido' )
			),
			'description'       => array(
			...
			'password'          => array(
				...
				'type'        => 'text',
				'description' => __( 'API Password from Mondido', 'woocommerce-gateway-mondido' ) . ' (<a href="https://admin.volvopayments.com/settings">https://admin.volvopaymentss.com/settings</a>)',
				'default'     => ''
			),
			'testmode'          => array(
			...
			'order_button_text' => array(
				...
				'type'    => 'text',
				'default' => __( 'Pay with Swish', 'woocommerce-gateway-mondido' ),
			),
		);
	}
